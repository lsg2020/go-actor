...
var (
	...
	gactorPackage = protogen.GoImportPath("github.com/lsg2020/gactor")
)
...
func GenerateFile(gen *protogen.Plugin, file *protogen.File) (*protogen.GeneratedFile, error) {
	...
	filename := file.GeneratedFilenamePrefix + ".gactor.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)

	g.P("// Code generated by protoc-gen-gactor. DO NOT EDIT.")
