var oxo = {
    ...
    ajax: {
        createGame: function (cb) {
            $.post("/Game/CreateGame/" + oxo.rand(), cb);
        },
        ...
        getGames: function (cb) {
            $.post("/Game/Index/" + oxo.rand(), function (data) {
                if (data && data.games) {
                    // games playing
                ...
                cb({ currentGames: data.games, availableGames: data.availables });
            });
        },
        getMoves: function (cb) {
            $.post("/Game/GetMoves/" + oxo.model.currentGame + oxo.rand(), cb);
        },
